...
var _react = /*#__PURE__*/ _interop_require_default(__webpack_require__("webpack/sharing/consume/default/react/react"));
...
function EducationRemoteApp(ref) {
    ...
    console.log('[edu-debug] React:', typeof _react.default, 'useState:', typeof _react.default?.useState, 'keys:', Object.keys(_react.default || {}).slice(0, 8).join(','));
    var _React_useState = _sliced_to_array(_react.default.useState('enrolled'), 2), activeTab = _React_useState[0], setActiveTab = _React_useState[1];
